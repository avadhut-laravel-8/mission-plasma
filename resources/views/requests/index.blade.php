...
<div class="container">
    <div class="row">
        <div class="col-md-12">
            <a class="btn btn-success float-right" href="{{ route('requests.create') }}" title="Add Request"> <i class="fa fa-plus-circle"></i> Add Request</a>
            ...
            <table id="request-table" class="table table-bordered" style="width:100%;">
                <thead>
                    <tr>
                        <th>Sr.No</th>
                        <th>Name</th>
