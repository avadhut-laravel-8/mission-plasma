    ...
    <div class="row justify-content-center">
        <div class="col-md-10">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form id="createDonorForm" method="POST" action="{{ route('donors.store') }}" novalidate="true">
                        @csrf
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                <button id="createDonorBtn" type="submit" class="btn btn-primary">
                                    {{ __('Submit') }}
                                </button>
                            </div>
                        </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#createDonorForm").submit(function(e) {
            e.preventDefault();
            ...
            submitHandler: function (form) {
                // console.log('test');
                $('#createDonorBtn').attr('disabled', 'disabled');
                form.submit();
            }
